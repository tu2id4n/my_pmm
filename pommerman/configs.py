...
def one_vs_one_8m8_env():
    """Start up an OneVsOne config with the default settings."""
    env = envs.v0.Pomme
    game_type = constants.GameType.OneVsOne
    env_entry_point = 'my_pommerman.v8:Pomme'
    env_id = 'OneVsOne-v8'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE_ONE_VS_ONE,
...
def radio_competition_v3_env():
    """Start up a team radio config with the default settings."""
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = 'my_pommerman.v3:Pomme'
...
def radio_competition_v4_env():
    """Start up a team radio config with the default settings."""
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = 'my_pommerman.v4:Pomme'
...
def radio_competition_v5_env():
    """Start up a team radio config with the default settings."""
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = 'my_pommerman.v5:Pomme'
