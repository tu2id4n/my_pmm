...
class Pomme(gym.Env):
    ...
    def _get_rewards(self):
        return reward_shaping.get_rewards_8m8(self._agents, self._step_count, self._max_steps, self.obs_pre, self.get_observations(), self.act_abs_pre)
